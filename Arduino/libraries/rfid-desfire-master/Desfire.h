...
public:
	...
	StatusCode MIFARE_DESFIRE_FormatPICC(mifare_desfire_tag *tag);
	StatusCode MIFARE_DESFIRE_CreateApp(mifare_desfire_tag *tag);
	StatusCode MIFARE_DESFIRE_CreateStdDataFile(mifare_desfire_tag *tag);
	...
	StatusCode MIFARE_DESFIRE_WriteData(mifare_desfire_tag *tag);
	StatusCode MIFARE_DESFIRE_ReadDataInno(mifare_desfire_tag *tag);
	StatusCode MIFARE_DESFIRE_InicializarDesfireAppInobusmx(mifare_desfire_tag *tag, byte inData[]);
	StatusCode MIFARE_DESFIRE_InicializarV2DesfireAppInobusmx(mifare_desfire_tag *tag, byte inData[]);
	StatusCode MIFARE_DESFIRE_InicializarV3DesfireAppInobusmx(mifare_desfire_tag *tag, byte llave[], byte tipoTisc[], byte EstadoTarjeta[], byte idTipoTisc[]);
	StatusCode MIFARE_DESFIRE_InicializarDesfireAppIntercambio(mifare_desfire_tag *tag, byte inData[]);
	StatusCode MIFARE_DESFIRE_ReadDataInnoParametros(mifare_desfire_tag *tag, byte app[], byte fileData[], byte *saldo);
	StatusCode MIFARE_DESFIRE_ReadDataInnoParametrosPago(mifare_desfire_tag *tag, byte app[], byte fileData[], byte *saldo, byte longi);
	StatusCode MIFARE_DESFIRE_WriteDataInnoParametros(mifare_desfire_tag *tag, byte app[], byte dataW[], byte longi);
